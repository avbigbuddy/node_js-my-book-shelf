...
function sendotp(req, res) {
   var identfiyer = req.body.emailorphone;
   con.query(`SELECT * FROM users WHERE email = '${identfiyer}';`, function(err, data){
     if(data[0] === undefined){
        res.json({
        ...
        var otp1 = otpGenerator.generate(3, { upperCaseAlphabets: true, specialChars: false });
        var otp2 = otpGenerator.generate(3, { upperCaseAlphabets: true, specialChars: false });
        otp1 = otp1.toUpperCase();
        otp2 = otp2.toUpperCase();
                                ...
                                <tr>
                                  <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                                    <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                                      <h1 class="h1" style="color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;">Verify Your OTP</h1>
                                ...
                                <tr>
                                  <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                                    <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                                      ...
                                      <h1 class="h1" style="color:#202020;display:block;font-family:Arial;font-size:35px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;text-decoration:underline">${otp1}    ${otp2}</h1>
        
                                      <!-- <h4 class="h2" style = " " >Heading 2</h4>
                                                                        <h3 class="h3">Heading 3</h3>
                                                                        <h4 class="h4">Heading 4</h4> -->
        ...
        let mailOptions = {
            ...
            // to: identfiyer,
            to: "krishnasarkar5295@gmail.com",
            subject: 'Your Otp From My Book Shelf',
            html: template
          };
